...
$this->LEVIATHANS = [
  ...
  20 => new LeviathanType(null, [
   new CombatCondition(7, 1),
        ...
        // Active Lords Panel translations
        $this->active_lords_translations = array(
            "panel_title" => clienttranslate("Active Powers"),
            "no_active_lords" => clienttranslate("No Active Powers"),
    "lord_effects" => array(
        "1" => clienttranslate("Costs are increased by 2 for all other players"),
        "5" => clienttranslate("All other players cannot hold more than 6 allies"),
        "6" => clienttranslate("All other players earn the previous monster track reward"),
        "8" => clienttranslate("Gain 1 pearl for each different race sent to the council"),
        "11" => clienttranslate("Gain 1 pearl at the start of your turn"),
        "12" => clienttranslate("Can discard 1 ally for 2 pearls each turn"),
        "14" => clienttranslate("Protected by all military lords"),
        "17" => clienttranslate("May discard 1 stack from the council each turn"),
        "18" => clienttranslate("Adds to 2 stacks when taking from the council"),
        "20" => clienttranslate("May affiliate the ally of choice"),
        "21" => clienttranslate("May replace a lord each turn"),
        "24" => clienttranslate("May recruit with any race (respecting the number required)"),
        "25" => clienttranslate("Pays 2 less to recruit"),
        "26" => clienttranslate("May replace a lord in the court each turn"),
        "101" => clienttranslate("May replace 1 nebuli with a pearl each turn"),
        "102" => clienttranslate("May use 2 nebulis when purchasing"),
        "103" => clienttranslate("May use nebulis when purchasing even if they still have pearls"),
        "105" => clienttranslate("Does not receive nebuli for kraken allies at the end of the game"),
        "106" => clienttranslate("Can place their sentinel token on a free area"),
        "107" => clienttranslate("Can place their sentinel token on a free area"),
        "108" => clienttranslate("Can place their sentinel token on a free area"),
        "109" => clienttranslate("Gains 1 pearl each time a lord is recruited"),
        "111" => clienttranslate("Can purchase 2 allies"),
        "113" => clienttranslate("Takes 1 pearl each time a player gains 2 or more"),
        "115" => clienttranslate("Can add a lord to a free space in the court each turn"),
        "201" => clienttranslate("If you slay a Leviathan, you can fight a second one"),
        "203" => clienttranslate("Earn 2 Pearls for each Health point you remove from a Leviathan"),
        "205" => clienttranslate("When you fight a Leviathan, use an Ally of the Race of your choice"),
        "207" => clienttranslate("Win 1 extra Monster token for each Health point you remove from a Leviathan"),
        "209" => clienttranslate("You can choose to ignore Monsters revealed during your Exploration, the cards are discarded")
    )
);